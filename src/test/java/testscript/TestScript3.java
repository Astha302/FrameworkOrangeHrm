...
public class TestScript3 extends BaseTest
{
	...
	public void TC_01_VerifyUIOfHRM()
	{
		...
		System.out.println("TC_01_VerifyUIOfHRM executed of tsc 03");
	}
	...
	public void TC_03VerifyInvalidLogin(String usernameData , String passwordData)
	{
		...
		System.out.println("TC_03VerifyInvalidLogin executed of tsc 03 ");
	...
	public void TC_02verifyValidLogin()
	{
		...
		System.out.println("TC_02verifyValidLogin executed of tsc 03");
	}
